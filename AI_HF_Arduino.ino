...
void loop() {
  ...
  if(receivedFlag) {
    ...
    */
    ...
    String data = "T=" + String(temp, 2);/* + "C, H=" + String(hum, 2) + "%, P=" + String(pres, 2) + "hPa";*/

    Serial.print("Küldés: ");
    Serial.println(data);

    int txState = radio.transmit(data);
    delay(100);
    String data1 = "H=" + String(hum, 2);
    txState = radio.transmit(data1);
    delay(100);
    String data2 = "P=" + String(pres, 2);
    txState = radio.transmit(data2);
